...
#define ASYNC_UDP_WT32_ETH01_H
  ...
  #define ASYNC_UDP_WT32_ETH01_VERSION      "AsyncUdp_WT32_ETH01 v2.0.3 for core v2.0.0+"
  ...
  extern "C" 
{
  ...
  #define ASYNC_UDP_WT32_ETH01_VERSION      "AsyncUdp_WT32_ETH01 v2.0.3 for core v1.0.6-"
